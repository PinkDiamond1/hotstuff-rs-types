...
impl ConsensusMsg {
    pub fn new_vote(view_number: ViewNumber, block_hash: BlockHash, keypair: &KeyPair) -> ConsensusMsg {
        let signature = {
...
impl QuorumCertificate {
    ...
    pub fn is_valid(&self, participant_set: &ParticipantSet) -> bool {
    ...
    pub fn genesis_qc(num_participants: usize) -> QuorumCertificate {
        QuorumCertificate {
            view_number: 0,
    ...
    pub fn is_correct_len(&self, num_participants: usize) -> bool {
